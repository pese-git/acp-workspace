...
- [x] Базовый `ConfigManager` (`tui_config.json`, load/save defaults для host/port/theme)
...
**Технические работы:**
- [x] Использовать JSON/TOML для конфига
- [x] Загружать при старте
- [x] Сохранять изменения
- [x] Использовать defaults
