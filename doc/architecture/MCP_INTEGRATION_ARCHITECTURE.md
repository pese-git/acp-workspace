...
- Логировать все MCP операции для аудита
...
- [Tool Registry](../../acp-server/src/acp_server/tools/registry.py)
- [Session Factory](../../acp-server/src/acp_server/protocol/session_factory.py)
